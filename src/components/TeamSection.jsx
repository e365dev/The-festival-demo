...
//     const prev = (currentIndex - 1 + teamMembers.length) % teamMembers.length;
//     const next = (currentIndex + 1) % teamMembers.length;
//     return {
//       left: teamMembers[prev],
//       center: teamMembers[currentIndex],
//       right: teamMembers[next]
//     };
//   };

//   const visibleCards = getVisibleCards();

//   const TeamCard = ({ member, position }) => {
//     const isCenter = position === 'center';
//     const scale = isCenter ? 'scale-100' : 'scale-75';
//     const opacity = isCenter ? 'opacity-100' : 'opacity-40';
//     const zIndex = isCenter ? 'z-30' : 'z-10';

//     return (
//       <div
//         className={`absolute transition-all duration-700 ease-out ${scale} ${opacity} ${zIndex} ${
//           position === 'left' ? 'left-0 md:left-8 lg:left-16' : 
//           position === 'right' ? 'right-0 md:right-8 lg:right-16' : 
//           'left-1/2 -translate-x-1/2'
//         }`}
//       >
//         <div className="group relative w-72 md:w-80 lg:w-96">
//           {/* Glow effect */}
//           <div className={`absolute -inset-1 bg-gradient-to-r from-pink-500/20 via-purple-500/20 to-cyan-500/20 rounded-2xl blur-xl transition-all duration-700 ${isCenter ? 'opacity-100 blur-2xl' : 'opacity-0'}`}></div>

//           {/* Card */}
//           <div className={`relative bg-gradient-to-b from-slate-900/80 to-slate-950/90 backdrop-blur-xl rounded-2xl border overflow-hidden transition-all duration-500 ${isCenter ? 'border-white/30' : 'border-white/10'}`}>
//             {/* Shine effect */}
//             <div className={`absolute inset-0 transition-opacity duration-1000 ${isCenter ? 'opacity-100' : 'opacity-0'}`}>
//               <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent skew-x-12 animate-shine"></div>
//             </div>
...
//                 src={member.image} 
//                 alt={member.name}
//                 className={`w-full h-full object-cover transition-transform duration-700 ${isCenter ? 'scale-110' : 'scale-100'}`}
//               />

//               {/* Hover overlay with gradient */}
//               <div className={`absolute inset-0 bg-gradient-to-t from-pink-500/40 via-purple-500/20 to-transparent transition-opacity duration-500 z-10 ${isCenter ? 'opacity-100' : 'opacity-0'}`}></div>

//               {/* Floating particles */}
//               {isCenter && (
//                 <div className="absolute inset-0 opacity-100 transition-opacity duration-700 z-20">
//                   <div className="absolute top-1/4 left-1/4 w-1 h-1 bg-white rounded-full animate-float-particle"></div>
//                   <div className="absolute top-3/4 right-1/4 w-1 h-1 bg-cyan-400 rounded-full animate-float-particle" style={{ animationDelay: '0.3s' }}></div>
//                   <div className="absolute top-1/2 right-1/3 w-1 h-1 bg-pink-400 rounded-full animate-float-particle" style={{ animationDelay: '0.6s' }}></div>
//                 </div>
...
//               {/* Department Badge */}
//               <div className="absolute top-4 right-4 z-20">
//                 <div className={`bg-black/60 backdrop-blur-md px-3 py-1.5 rounded-full border transition-colors duration-300 ${isCenter ? 'border-cyan-400' : 'border-cyan-400/30'}`}>
//                   <span className="text-xs font-bold text-cyan-400 uppercase tracking-wider">
//                     {member.department}
//                   </span>
//                 </div>
...
//             {/* Info Section */}
//             <div className="relative p-6 space-y-3">
//               <h3 className={`text-xl font-bold transition-all duration-300 ${isCenter ? 'text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-cyan-400' : 'text-white'}`}>
//                 {member.name}
//               </h3>
              
//               <p className={`text-sm font-semibold transition-colors duration-300 ${isCenter ? 'text-purple-300' : 'text-purple-400'}`}>
//                 {member.role}
//               </p>

//               <p className={`text-xs leading-relaxed transition-colors duration-300 ${isCenter ? 'text-gray-300' : 'text-gray-400'}`}>
//                 {member.bio}
//               </p>
...
//                 <a 
//                   href={member.social.linkedin}
//                   className="w-9 h-9 flex items-center justify-center rounded-full bg-white/5 border border-white/10 text-gray-400 hover:bg-gradient-to-r hover:from-blue-600 hover:to-blue-400 hover:text-white hover:border-transparent transition-all duration-300 hover:scale-110"
//                 >
//                   <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
//                     <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
//                   </svg>
...
//         {/* Carousel Container */}
//         <div className="relative h-[600px] md:h-[650px] lg:h-[700px] flex items-center justify-center">
//           {/* Navigation Buttons */}
//           <button
//             onClick={prevSlide}
//             className="absolute left-4 md:left-8 z-40 w-12 h-12 flex items-center justify-center rounded-full bg-white/5 border border-white/20 text-white hover:bg-white/10 hover:border-white/40 transition-all duration-300 hover:scale-110 backdrop-blur-md"
...
//           <button
//             onClick={nextSlide}
//             className="absolute right-4 md:right-8 z-40 w-12 h-12 flex items-center justify-center rounded-full bg-white/5 border border-white/20 text-white hover:bg-white/10 hover:border-white/40 transition-all duration-300 hover:scale-110 backdrop-blur-md"
...
//             <TeamCard member={visibleCards.left} position="left" />
//             <TeamCard member={visibleCards.center} position="center" />
//             <TeamCard member={visibleCards.right} position="right" />
//           </div>
//         </div>
...
//                 index === currentIndex 
//                   ? 'bg-gradient-to-r from-pink-500 to-cyan-500 w-8' 
...
//     // FIX: z-30 ➜ z-20 (prevents navbar overlap)
...
//         className={`absolute transition-all duration-700 ease-out ${scale} ${opacity} ${zIndex} ${
//           position === 'left'
//             ? 'left-0 md:left-8 lg:left-16'
//             : position === 'right'
//             ? 'right-0 md:right-8 lg:right-16'
//             : 'left-1/2 -translate-x-1/2'
//         }`}
//       >
//         <div className="group relative w-72 md:w-80 lg:w-96">
//           <div className={`absolute -inset-1 bg-gradient-to-r from-pink-500/20 via-purple-500/20 to-cyan-500/20 rounded-2xl blur-xl transition-all duration-700 ${isCenter ? 'opacity-100 blur-2xl' : 'opacity-0'}`} />
...
//             <div className="relative p-6 space-y-3">
//               <h3 className={`text-xl font-bold ${isCenter ? 'text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-cyan-400' : 'text-white'}`}>
//                 {member.name}
//               </h3>
...
//   return (
//     // FIX: z-0 creates stacking context below navbar
//     <section className="relative z-0 min-h-screen bg-black text-white py-20 px-4 md:px-6 overflow-hidden">
//       <div className="relative max-w-7xl mx-auto">
//         <div className="text-center mb-16">
...
//           <button
//             onClick={prevSlide}
//             className="absolute left-4 z-40 w-12 h-12 flex items-center justify-center rounded-full bg-white/5 border border-white/20 hover:scale-110 transition"
//           >
//             <ChevronLeft />
//           </button>
...
//           <button
//             onClick={nextSlide}
//             className="absolute right-4 z-40 w-12 h-12 flex items-center justify-center rounded-full bg-white/5 border border-white/20 hover:scale-110 transition"
//           >
//             <ChevronRight />
//           </button>
