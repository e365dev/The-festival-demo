...
//     logo: "https://upload.wikimedia.org/wikipedia/commons/6/6a/Johnson_%26_Johnson_Logo.svg"
//   },
//   {
//     id: 2,
//     name: "Salesforce",
...
//     id: 3,
//     name: "AAOS",
//     logo: "https://upload.wikimedia.org/wikipedia/commons/4/49/American_Academy_of_Orthopaedic_Surgeons_logo.svg"
//   },
//   {
//     id: 4,
//     name: "Lenovo",
...
//     id: 5,
//     name: "Novo Nordisk",
//     logo: "https://upload.wikimedia.org/wikipedia/commons/1/1b/Novo_Nordisk_logo.svg"
//   },
//   {
//     id: 6,
//     name: "Tech Mahindra",
//     logo: "https://upload.wikimedia.org/wikipedia/commons/9/9e/Tech_Mahindra_New_Logo.svg"
//   },
//   {
//     id: 7,
//     name: "GSK",
//     logo: "https://upload.wikimedia.org/wikipedia/commons/2/2f/GSK_logo_2022.svg"
//   },
//   {
//     id: 8,
//     name: "Hitachi",
//     logo: "https://upload.wikimedia.org/wikipedia/commons/4/48/Hitachi_logo.svg"
//   },
//   {
//     id: 9,
//     name: "BSE",
//     logo: "https://upload.wikimedia.org/wikipedia/commons/5/5c/Bombay_Stock_Exchange_Logo.svg"
//   },
//   {
//     id: 10,
//     name: "Microsoft",
...
//           {/* ⬇️ Gradient masked overlays removed */}

//           <div className="overflow-hidden">
//             <div className="flex animate-scroll-sponsors hover:pause-scroll">
//               {/* Three repeated sets for infinite loop */}
//               {[...sponsors, ...sponsors, ...sponsors].map((sponsor, index) => (
//                 <div key={index} className="flex-shrink-0 mx-8 group">
//                   <div className="w-32 h-32 md:w-40 md:h-40 flex items-center justify-center bg-white/5 backdrop-blur-sm rounded-xl border border-slate-800 hover:border-pink-500/50 transition-all duration-300 hover:scale-110 hover:bg-white/10">
//                     <img
//                       src={sponsor.logo}
//                       alt={sponsor.name}
//                       className="w-20 h-20 md:w-24 md:h-24 object-contain filter grayscale hover:grayscale-0 transition-all duration-300 opacity-60 group-hover:opacity-100"
//                       onError={(e) => {
